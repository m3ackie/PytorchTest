...
data_dir = os.path.join("cifar", "cifar-10-batches-py")
train_o_dir = os.path.join("cifar", "cifar-10-png", "raw_train")
test_o_dir = os.path.join("cifar", "cifar-10-png", "raw_test")
